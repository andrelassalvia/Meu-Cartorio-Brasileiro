...
class UkCitiesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $ukCitiesAndTowns = [
            ...
            [
                'name' => "Builth Wells / Llanfair-ym-Muallt",
                'country_id' => 2
            ],
            [
                'name' => "Bungay",
            ...
            [
                'name' => "Campbeltown / Ceann Loch Chille Chiarain",
                'country_id' => 2
            ],
            [
                'name' => "Cannock",
            ...
            [
                'name' => "Criccieth / Cricieth",
                'country_id' => 2
            ],
            [
                'name' => "Crickhowell / Crughywel",
                'country_id' => 2
            ],
            [
                'name' => "Cricklade",
            ...
            [
                'name' => "Fort William / An Gearasdan",
                'country_id' => 2
            ],
            [
                'name' => "Fowey",
            ...
            [
                'name' => "Hay-on-Wye / Y Gelli Gandryll",
                'country_id' => 2
            ],
            [
                'name' => "Haywards Heath",
            ...
            [
                'name' => "Holyhead / Caergybi",
                'country_id' => 2
            ],
            [
                'name' => "Holywell / Treffynnon",
                'country_id' => 2
            ],
            [
                'name' => "Holywood",
            ...
            [
                'name' => "Lampeter / Llanbedr Pont Steffan",
                'country_id' => 2
            ],
            [
                'name' => "Lanark",
            ...
            [
                'name' => "Llandovery / Llanymddyfri",
                'country_id' => 2
            ],
            [
                'name' => "Llandrindod Wells / Llandrindod",
                'country_id' => 2
            ],
            [
                'name' => "Llandudno",
            ...
            [
                'name' => "Llantwit Major / Llanilltud Fawr",
                'country_id' => 2
            ],
            [
            ...
            [
                'name' => "Lochgilphead / Ceann Loch Gilb",
                'country_id' => 2
            ],
            [
                'name' => "Lochmaben",
            ...
            [
                'name' => "Milford Haven / Aberdaugleddau",
                'country_id' => 2
            ],
            [
                'name' => "Millom",
            ...
            [
                'name' => "Monmouth / Trefynwy",
                'country_id' => 2
            ],
            [
                'name' => "Montgomery / Trefaldwyn",
                'country_id' => 2
            ],
            [
                'name' => "Montrose",
            ...
            [
                'name' => "Narberth / Arberth",
                'country_id' => 2
            ],
            [
                'name' => "Neath / Castell-nedd",
                'country_id' => 2
            ],
            [
                'name' => "Needham Market",
            ...
            [
                'name' => "Newcastle Emlyn / Castell Newydd Emlyn",
                'country_id' => 2
            ],
            [
            ...
            [
                'name' => "Pembroke Dock / Doc Penfro",
                'country_id' => 2
            ],
            [
                'name' => "Pembroke / Penfro",
                'country_id' => 2
            ],
            [
                'name' => "Penarth",
            ...
            [
                'name' => "St Just / St Just in Penwith",
                'country_id' => 2
            ],
            [
                'name' => "St Neots",
